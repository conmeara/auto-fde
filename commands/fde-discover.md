...
Run the discovery phase of this Auto-FDE project. Use the discovery skill
(auto-fde:discovery) for the method; read
`${CLAUDE_PLUGIN_ROOT}/reference/project-layout.md` for where everything
goes.
...
- **No `project.md` yet** → start with the kickoff interview regardless of
...
- **No arguments, project.md exists** → report what discovery inputs exist
