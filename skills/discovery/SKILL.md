...
`${CLAUDE_PLUGIN_ROOT}/reference/engagement-layout.md`.

Check state first: no `engagement.md` means kickoff hasn't happened — run it
before any extraction, whatever the user handed you.

## Kickoff interview

Fill `${CLAUDE_PLUGIN_ROOT}/templates/schemas/engagement-brief-template.md`
...
work plan. Write `engagement.md`. Done when every section is filled or
